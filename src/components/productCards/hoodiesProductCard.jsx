...
export default class HoodiesProductCard extends React.Component { 
...
<h1><span style={{color:'rgb(69, 146, 177)', borderBottom:'4px solid rgb(69, 146, 177)'}}>Hoodies / Jackets</span> </h1>
</div>
</div>
