...
export default class AirForce1ProductCard extends React.Component { 
    ...
    state = {
      ...
      async componentDidMount(){
        const response = await fetch('http://localhost:5000/airForce1s');
...
<h1><span style={{color:'rgb(69, 146, 177)', borderBottom:'4px solid rgb(69, 146, 177)'}}>Air Force One</span> </h1>
</div>
</div>
