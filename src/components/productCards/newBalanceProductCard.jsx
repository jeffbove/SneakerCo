...
export default class NewBalanceProductCard extends React.Component { 
    ...
    state = {
      ...
      async componentDidMount(){
        const response = await fetch('http://localhost:5000/newbalances');
...
<h1><span style={{color:'rgb(69, 146, 177)', borderBottom:'4px solid rgb(69, 146, 177)'}}>New Balance</span> </h1>
</div>
</div>
   ...
   <div className='cardWrapper'>
        ...
        <div> 
           <div className='m3'>
           <div> <b>{this.state.shoe[13].name}</b>  </div> <br/>
           <img src={this.state.shoe[13].img}></img>
               <div><b>Colorway:</b>  {this.state.shoe[13].color}</div>
               <div><b>Price:</b>  {this.state.shoe[13].retail_price}</div>
               <br/>
               <a href={this.state.shoe[13].link}>
                       <button>BUY</button>
            </a> 
           </div>
        </div>
   ...
   <div className='cardWrapper'>
        ...
        <div> 
           <div className='m3'>
           <div> <b>{this.state.shoe[10].name}</b>  </div> <br/>
           <img src={this.state.shoe[10].img}></img>
               <div><b>Colorway:</b>  {this.state.shoe[10].color}</div>
               <div><b>Price:</b>  {this.state.shoe[10].retail_price}</div>
               <br/>
               <a href={this.state.shoe[10].link}>
                       <button>BUY</button>
            </a> 
           </div>
        </div>
