...
export default class Jordan4ProductCard extends React.Component { 
    ...
    state = {
      ...
      async componentDidMount(){
        const response = await fetch('http://localhost:5000/jordan4s');
...
<h1><span style={{color:'rgb(69, 146, 177)', borderBottom:'4px solid rgb(69, 146, 177)'}}>Jordan 4 </span> </h1>
</div>
</div>
